...
function About() {
  ...
  return (
    <div className='text-white lg:pb-7  relative   lg:h-[60vh] space-y-4 flex flex-col items-center mt-2 lg:mt-0  '>
      <div className="about">
        <span className= 'relative  lg:text-2xl text-[23px] font-bold after:border-[1px] lg:after:border-[2px] after:border-blue-600 after:absolute after:w-[150%] after:-bottom-1 after:-left-3'>About</span>
      </div>
      <div className="img  bg-blue-700 h-[75px]  w-[75px] border-[3px]  rounded-full overflow-hidden">
              <img src={Abimg} className=' w-full ' alt="" />


            </div>
      <div className=" flex   relative  lg:flex-row flex-col justify-center  lg:space-x-28">
        <div className=" lg:text-right lg:w-60  lg:text-3xl  text-[30px] p-3 font-semibold">
          Hi. I'm vinay,nice to meet you. Let's take a look around!

        </div>
          <div className=" lg:text-left lg:w-96 p-3 lg:text-[20px]">
