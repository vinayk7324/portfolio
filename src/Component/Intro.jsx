...
function Intro() {
  ...
  return (
    <div className="Intro lg:mt-0 mt-20   lg:w-[80%] lg:h-[100%] lg:ps-10  overflow-y-hidden   lg:py-8  border-red-600 flex justify-between items-center lg:items-start  ">
    <div className="flex space-y-6      lg:mt-32  flex-col overflow-scroll company overflow-x-hidden max-h-[73%]   p-4 lg:p-6  lg:rounded-md IntroShadow lg:IntroShadow w-[100vw]  lg:w-[70%] ">
     ...
     <div className=" flex flex-col   space-y-3">
        ...
        <span className='text-gray-400 lg:flex  lg:text-just font-semibold text-[15px] lg:text-[23px]'>
      ...
      <div className=" lg:flex lg:justify-between ">
        ...
        <div  className={ `${Scrollbtn?"lg:block hidden":"hidden"} cursor-pointer flex items-center justify-center  border-cyan-400 h-10 rounded-full companyLogo  animate-bounce bg-blue-700 w-10 text-white -top-20 right-4`}>
    <span className="material-symbols-rounded mt-[8px] flex justify-center items-center text-[35px]">
