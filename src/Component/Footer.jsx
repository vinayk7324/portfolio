  ...
  return (
    <>
      <div className='' >
        ...
        <div className=" block lg:hidden z-[-2] bg-[#f4f4f7] w-[100vw]">
        
<footer className="relative lg:py-20 py-12 flex flex-col items-center bg-cyan-900 overflow-hidden md:py-40">
    <div className="relative z-[1] container m-auto px-6 md:px-12">
        <div className="m-auto md:w-10/12 lg:w-8/12 xl:w-6/12">
            <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
                <div className="w-full z-[-2] space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start">
