...
function Navbar() {
  ...
  return (
    <div className=' w-full lg:h-24 lg:p-0  lg:z-0 z-[1] bg-[#1a1a5f] lg:static fixed space-y-2  lg:shadow-[#191818ac] lg:shadow-lg  flex flex-col  items-center '>
      ...
      <div className="  flex  w-full lg:space-y-0 lg:px-0 px-4  items-center lg:flex-row items-center justify-between">
       ...
       <div className=" absolute lg:sticky lg:w-[40%] -bottom-[28px] left-0 lg:bottom-0  w-[100vw] ">
       <div className="      lg:bg-inherit  bg-white 
        ...
        <div className=" lg:hidden block    p-1 text-[#3fc0ef]">
